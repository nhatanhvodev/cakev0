...
/** DefaultRole - The default role assigned to new organization members */
class DefaultRole
{
    /**
     *
    ...
    public RoleSetDefaultRoleObject $object;
     ...
     * @phpstan-pure
     */
    public function __construct(RoleSetDefaultRoleObject $object, string $id, string $name, string $key, int $createdAt, int $updatedAt, ?string $description = null, ?int $membersCount = null, ?bool $hasMembers = null)
    {
        $this->object = $object;
        $this->id = $id;
        $this->name = $name;
