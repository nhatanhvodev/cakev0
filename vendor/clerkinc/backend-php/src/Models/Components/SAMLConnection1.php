...
class SAMLConnection1
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, string $name, string $domain, bool $active, string $provider, bool $syncUserAttributes, int $createdAt, int $updatedAt, ?array $domains = null, ?bool $allowSubdomains = null, ?bool $allowIdpInitiated = null, ?bool $disableAdditionalIdentifications = null)
    {
        $this->id = $id;
        $this->name = $name;
        $this->domain = $domain;
