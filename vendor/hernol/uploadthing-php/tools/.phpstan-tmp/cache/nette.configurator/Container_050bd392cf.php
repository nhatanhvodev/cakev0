...
class Container_050bd392cf extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_050bd392cf $container)
			{
	...
	public function createService082(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			$this->getService('083'),
			[],
			['analyseAndScan' => ['/home/hernol/apps/uploadthing-php/tests'], 'analyse' => []]
		);
	}
	...
	public function createServiceContainer(): Container_050bd392cf
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludes_analyse' => [],
			'excludePaths' => ['analyseAndScan' => ['/home/hernol/apps/uploadthing-php/tests'], 'analyse' => []],
			'level' => 'max',
			'paths' => ['/home/hernol/apps/uploadthing-php/src'],
			'exceptions' => [
				'implicitThrows' => true,
