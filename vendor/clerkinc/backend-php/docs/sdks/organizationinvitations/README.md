...
<!-- UsageSnippet language="php" operationID="ListInstanceOrganizationInvitations" method="get" path="/organization_invitations" -->
```php
...
<!-- UsageSnippet language="php" operationID="CreateOrganizationInvitation" method="post" path="/organizations/{organization_id}/invitations" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="ListOrganizationInvitations" method="get" path="/organizations/{organization_id}/invitations" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="CreateOrganizationInvitationBulk" method="post" path="/organizations/{organization_id}/invitations/bulk" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="ListPendingOrganizationInvitations" method="get" path="/organizations/{organization_id}/invitations/pending" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="GetOrganizationInvitation" method="get" path="/organizations/{organization_id}/invitations/{invitation_id}" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="RevokeOrganizationInvitation" method="post" path="/organizations/{organization_id}/invitations/{invitation_id}/revoke" -->
```php
declare(strict_types=1);
