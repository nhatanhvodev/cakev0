...
/** RevokeM2MTokenResponseBody - 200 OK */
class RevokeM2MTokenResponseBody
{
    ...
    public RevokeM2MTokenObject $object;
     ...
     * @phpstan-pure
     */
    public function __construct(RevokeM2MTokenObject $object, string $id, string $subject, bool $revoked, bool $expired, float $createdAt, float $updatedAt, ?array $scopes = null, ?string $revocationReason = null, ?float $expiration = null, ?float $lastUsedAt = null, mixed $claims = null)
    {
        $this->object = $object;
        $this->id = $id;
