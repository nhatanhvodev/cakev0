...
class M2mTokens
{
     ...
     * @phpstan-pure
     */
    public function __construct(GetM2MTokensObject $object, string $id, string $subject, bool $revoked, bool $expired, float $createdAt, float $updatedAt, ?array $scopes = null, ?string $revocationReason = null, ?float $expiration = null, ?float $lastUsedAt = null, mixed $claims = null)
    {
        $this->object = $object;
        $this->id = $id;
