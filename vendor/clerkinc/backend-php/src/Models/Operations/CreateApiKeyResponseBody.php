...
/** CreateApiKeyResponseBody - 200 OK */
class CreateApiKeyResponseBody
{
    /**
     *
     * @var CreateApiKeyObject $object
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('object')]
    #[\Speakeasy\Serializer\Annotation\Type('\Clerk\Backend\Models\Operations\CreateApiKeyObject')]
    ...
    /**
     * @param  CreateApiKeyObject  $object
     * @param  string  $id
     * @param  string  $type
     ...
     * @phpstan-pure
     */
    public function __construct(CreateApiKeyObject $object, string $id, string $type, string $subject, string $name, array $scopes, string $secret, bool $revoked, bool $expired, float $createdAt, float $updatedAt, mixed $claims = null, ?string $revocationReason = null, ?float $expiration = null, ?string $createdBy = null, ?float $lastUsedAt = null, ?string $description = null)
    {
        $this->object = $object;
        $this->id = $id;
        $this->type = $type;
