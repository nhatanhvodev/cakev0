...
/** VerifyM2MTokenResponseBody - 200 OK */
class VerifyM2MTokenResponseBody
{
    /**
     *
     * @var VerifyM2MTokenObject $object
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('object')]
    #[\Speakeasy\Serializer\Annotation\Type('\Clerk\Backend\Models\Operations\VerifyM2MTokenObject')]
    ...
    /**
     * @param  VerifyM2MTokenObject  $object
     * @param  string  $id
     ...
     * @phpstan-pure
     */
    public function __construct(VerifyM2MTokenObject $object, string $id, string $subject, bool $revoked, bool $expired, float $createdAt, float $updatedAt, ?array $scopes = null, ?string $revocationReason = null, ?float $expiration = null, ?float $lastUsedAt = null, mixed $claims = null)
    {
        $this->object = $object;
        $this->id = $id;
