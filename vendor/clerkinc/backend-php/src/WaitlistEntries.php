...
class WaitlistEntries
{
    ...
    public function bulkCreate(?array $request = null, ?Options $options = null): Operations\CreateBulkWaitlistEntriesResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/waitlist_entries/bulk');
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateBulkWaitlistEntries', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, 'array<\Clerk\Backend\Models\Components\WaitlistEntry>', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\CreateBulkWaitlistEntriesResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    waitlistEntryList: $obj);
    ...
    public function create(?Operations\CreateWaitlistEntryRequestBody $request = null, ?Options $options = null): Operations\CreateWaitlistEntryResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateWaitlistEntry', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function delete(string $waitlistEntryId, ?Options $options = null): Operations\DeleteWaitlistEntryResponse
    {
        ...
        $request = new Operations\DeleteWaitlistEntryRequest(
            waitlistEntryId: $waitlistEntryId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/waitlist_entries/{waitlist_entry_id}', Operations\DeleteWaitlistEntryRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('DELETE', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'DeleteWaitlistEntry', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\DeleteWaitlistEntryResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    deletedObject: $obj);
        ...
        } elseif (Utils\Utils::matchStatusCodes($statusCode, ['400', '404', '409', '422'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $httpResponse = $this->sdkConfiguration->hooks->afterSuccess(new Hooks\AfterSuccessContext($hookContext), $httpResponse);
    ...
    public function invite(string $waitlistEntryId, ?Operations\InviteWaitlistEntryRequestBody $requestBody = null, ?Options $options = null): Operations\InviteWaitlistEntryResponse
    {
        ...
        $request = new Operations\InviteWaitlistEntryRequest(
            waitlistEntryId: $waitlistEntryId,
            requestBody: $requestBody,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/waitlist_entries/{waitlist_entry_id}/invite', Operations\InviteWaitlistEntryRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'InviteWaitlistEntry', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\WaitlistEntry', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\InviteWaitlistEntryResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    waitlistEntry: $obj);
    ...
    public function list(?Operations\ListWaitlistEntriesRequest $request = null, ?Options $options = null): Operations\ListWaitlistEntriesResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'ListWaitlistEntries', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
    ...
    public function reject(string $waitlistEntryId, ?Options $options = null): Operations\RejectWaitlistEntryResponse
    {
        ...
        $request = new Operations\RejectWaitlistEntryRequest(
            waitlistEntryId: $waitlistEntryId,
        );
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/waitlist_entries/{waitlist_entry_id}/reject', Operations\RejectWaitlistEntryRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'RejectWaitlistEntry', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Clerk\Backend\Models\Components\WaitlistEntry', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\RejectWaitlistEntryResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    waitlistEntry: $obj);
