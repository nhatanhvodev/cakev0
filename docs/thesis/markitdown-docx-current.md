...
**ThS. Lê Văn Quốc Anh** **Võ Lý Nhật Anh; MSSV: 2251120333**

***Thành phố Hồ Chí Minh, ngày 26 tháng 7 năm 2026***

**LỜI CAM ĐOAN**

Tôi tên là Võ Lý Nhật Anh, MSSV: 2251120333, sinh viên ngành Công nghệ thông tin, Viện Công nghệ thông tin và Điện, Điện tử, Trường Đại học Giao thông Vận tải Thành phố Hồ Chí Minh. Tôi xin cam đoan đồ án tốt nghiệp với đề tài "Xây dựng website thương mại điện tử tích hợp AI chăm sóc khách hàng" là công trình do tôi trực tiếp nghiên cứu, phân tích, thiết kế và thực hiện dưới sự hướng dẫn của ThS. Lê Văn Quốc Anh.

Các nội dung, số liệu, kết quả và mã nguồn được trình bày trong đồ án là trung thực, phản ánh đúng quá trình thực hiện. Những thông tin, tài liệu tham khảo từ các nguồn khác đều được trích dẫn đầy đủ trong danh mục tài liệu tham khảo. Tôi hoàn toàn chịu trách nhiệm trước Nhà trường về lời cam đoan này.
...
Nhận thấy nhu cầu tự động hóa bán hàng và chăm sóc khách hàng ngày càng rõ rệt, sinh viên thực hiện đề tài “Xây dựng website thương mại điện tử tích hợp AI chăm sóc khách hàng”. Hệ thống đặt bánh trực tuyến được mở rộng thành nền tảng thương mại điện tử có chatbot AI, hỗ trợ khách hàng trong quá trình tìm hiểu sản phẩm, đặt hàng và tiếp nhận hỗ trợ.

Báo cáo trình bày quá trình khảo sát, phân tích, thiết kế và hiện thực hệ thống; đồng thời đối chiếu các chức năng đã phát triển với codebase hiện tại. Trọng tâm cập nhật là các nghiệp vụ thương mại điện tử, AI chăm sóc khách hàng, tích hợp thanh toán, email hóa đơn và quy trình chuyển tiếp sang nhân viên hỗ trợ.

LỜI CẢM ƠN

Trong quá trình thực hiện đồ án tốt nghiệp "Xây dựng website thương mại điện tử tích hợp AI chăm sóc khách hàng", em đã nhận được sự hướng dẫn, hỗ trợ và động viên quý báu từ quý thầy cô, gia đình và bạn bè.

Trước hết, em xin bày tỏ lòng biết ơn sâu sắc đến ThS. Lê Văn Quốc Anh, giảng viên hướng dẫn. Thầy đã tận tình định hướng, góp ý chuyên môn và đồng hành cùng em trong quá trình khảo sát, phân tích, thiết kế và hoàn thiện hệ thống. Những chỉ dẫn của Thầy là cơ sở quan trọng giúp em hoàn thành đồ án này.

Em xin trân trọng cảm ơn Ban Giám hiệu Trường Đại học Giao thông Vận tải Thành phố Hồ Chí Minh, quý thầy cô Viện Công nghệ thông tin và Điện, Điện tử đã trang bị kiến thức nền tảng và tạo điều kiện thuận lợi trong suốt quá trình học tập, nghiên cứu.

Em cũng xin cảm ơn gia đình và bạn bè đã luôn động viên, chia sẻ và hỗ trợ em trong thời gian thực hiện đồ án.

Mặc dù đã nỗ lực hoàn thành, đồ án khó tránh khỏi những hạn chế do kinh nghiệm thực tế và thời gian thực hiện còn có giới hạn. Em rất mong nhận được các ý kiến đóng góp của quý thầy cô để tiếp tục hoàn thiện kiến thức và phát triển hệ thống tốt hơn.
...
Ngoài các chức năng nền tảng nêu trên, phiên bản hiện tại có các nhóm chức năng được triển khai và đối chiếu trực tiếp với codebase như sau:
...
* Chat tư vấn sản phẩm, chính sách và FAQ
* Tìm kiếm, gợi ý và so sánh sản phẩm; lọc theo dị ứng
* Tra cứu đơn hàng, khuyến mãi, coupon, đánh giá và sản phẩm yêu thích
* Tạo đơn COD qua chat cho khách hàng đã đăng nhập
* Thu thập yêu cầu báo giá bánh đặt riêng và xử lý khiếu nại
* Chuyển tiếp sang nhân viên, lưu lịch sử và quản trị phiên chat
...
| **Use Case Description** | |
| **Use Case ID:** | UC-12 |
| **Tên Use Case:** | Chat với AI CSKH |
| **Tác nhân chính:** | Khách hàng (guest hoặc đã đăng nhập) |
| **Tổng quan:** | Mô tả quá trình khách hàng gửi tin nhắn qua widget website hoặc Messenger để nhận tư vấn, tra cứu và thực hiện các action được phép. |
| **Độ ưu tiên:** | Cao |
| **Mối quan hệ:** | <<include>> Phân loại intent, truy xuất tri thức/lịch sử; <<extend>> Handoff sang nhân viên. |
| **Tiền điều kiện:** | Widget chat hoạt động, AI service có thể truy cập và khách có guest token hoặc thông tin đăng nhập hợp lệ. |
| **Hậu điều kiện:** | Tin nhắn và phản hồi được lưu theo chat\_session; khách nhận được câu trả lời, kết quả action hoặc trạng thái handoff. |
| **Dòng sự kiện chính:** | 1. Khách mở widget và nhập câu hỏi. 2. PHP proxy chuyển yêu cầu đến FastAPI. 3. AI phân loại một trong 20 intent. 4. AI truy xuất dữ liệu hoặc gọi action phù hợp. 5. Hệ thống trả lời và lưu lịch sử hội thoại. |
| **Dòng sự kiện phụ:** | A. Không đủ ngữ cảnh hoặc khách yêu cầu người thật: AI chuyển handoff. B. Vượt giới hạn tốc độ: hệ thống báo khách thử lại sau. C. Dữ liệu action không hợp lệ: AI yêu cầu bổ sung thông tin. |
...
| **Use Case Description** | |
| **Use Case ID:** | UC-13 |
| **Tên Use Case:** | Tạo đơn COD qua chat |
| **Tác nhân chính:** | Khách hàng đã đăng nhập |
| **Tổng quan:** | Mô tả quá trình AI thu thập sản phẩm, số lượng và thông tin nhận hàng rồi gọi API nội bộ để tạo đơn COD. |
| **Độ ưu tiên:** | Cao |
| **Mối quan hệ:** | <<include>> Kiểm tra đăng nhập, tồn kho, thông tin người nhận và chữ ký HMAC; <<extend>> Chat AI. |
| **Tiền điều kiện:** | Khách đã đăng nhập; sản phẩm còn hàng; có tên người nhận, số điện thoại và địa chỉ hợp lệ. |
| **Hậu điều kiện:** | Đơn và chi tiết đơn được lưu, tồn kho được cập nhật và khách nhận mã đơn/trạng thái tạo đơn. |
| **Dòng sự kiện chính:** | 1. Khách xác nhận muốn đặt COD. 2. AI thu thập dữ liệu còn thiếu. 3. AI gửi payload ký HMAC đến Internal Order API. 4. API kiểm tra quyền, số lượng và dữ liệu. 5. Hệ thống tạo orders/order\_items và phản hồi kết quả cho AI. |
| **Dòng sự kiện phụ:** | A. Chưa đăng nhập: AI trả URL đăng nhập. B. Thiếu dữ liệu: AI hỏi lại. C. Hết hàng hoặc số lượng vượt giới hạn: API từ chối và AI thông báo để khách chọn lại. |
...
| **Use Case Description** | |
| **Use Case ID:** | UC-14 |
| **Tên Use Case:** | Handoff sang nhân viên |
| **Tác nhân chính:** | Khách hàng, AI CSKH, nhân viên hỗ trợ |
| **Tổng quan:** | Mô tả quá trình chuyển một hội thoại từ AI sang nhân viên khi có khiếu nại, khách yêu cầu gặp người thật hoặc AI không có đủ ngữ cảnh. |
| **Độ ưu tiên:** | Cao |
| **Mối quan hệ:** | <<include>> Lưu chat session/event; <<extend>> Tạo support ticket và thông báo Telegram khi cấu hình. |
| **Tiền điều kiện:** | Có phiên chat đang hoạt động; xảy ra intent complaint/handoff\_request hoặc hệ thống xác định cần hỗ trợ thủ công. |
| **Hậu điều kiện:** | Phiên chat ở trạng thái chờ/đang xử lý; nhân viên có thể nhận phiên, phản hồi, đóng hoặc mở lại. |
| **Dòng sự kiện chính:** | 1. Khách yêu cầu hỗ trợ hoặc AI phát hiện khiếu nại. 2. AI cập nhật trạng thái handoff. 3. Với complaint/handoff\_request, hệ thống tạo ticket và gửi thông báo nếu cấu hình. 4. Nhân viên xem danh sách phiên. 5. Nhân viên nhận phiên và trả lời khách. |
| **Dòng sự kiện phụ:** | A. Không có nhân viên sẵn sàng: phiên vẫn chờ xử lý. B. Handoff do không đủ ngữ cảnh sau retry: session được đánh dấu handoff để quản trị viên tiếp nhận. |
...
*Hình 2.11. Sơ đồ lớp cập nhật của hệ thống thương mại điện tử tích hợp AI CSKH*
...
**2.8. Sơ đồ bổ sung cho AI CSKH và email**

2.8.1. Sơ đồ Use Case AI CSKH

![](data:image/png;base64...)

*Hình 2.12. Use Case tổng quát của phân hệ AI CSKH*

2.8.2. Sơ đồ hoạt động Use Case Chat với AI CSKH

![](data:image/png;base64...)

*Hình 2.13. Activity Diagram xử lý hội thoại AI CSKH*

2.8.3. Sơ đồ tuần tự Use Case Chat với AI CSKH

![](data:image/png;base64...)

*Hình 2.14. Sequence Diagram xử lý hội thoại AI CSKH*

2.8.4. Sơ đồ hoạt động Use Case Tạo đơn COD qua chat

![](data:image/png;base64...)

*Hình 2.15. Activity Diagram tạo đơn COD qua chat*

2.8.5. Sơ đồ tuần tự Use Case Tạo đơn COD qua chat

![](data:image/png;base64...)

*Hình 2.16. Sequence Diagram tạo đơn COD qua chat*

2.8.6. Sơ đồ hoạt động Use Case Handoff sang nhân viên

![](data:image/png;base64...)

*Hình 2.17. Activity Diagram chuyển tiếp nhân viên hỗ trợ*

2.8.7. Sơ đồ tuần tự Use Case Handoff sang nhân viên

![](data:image/png;base64...)

*Hình 2.18. Sequence Diagram chuyển tiếp và phản hồi nhân viên*

2.8.8. Sơ đồ hoạt động Use Case Gửi email và hóa đơn

![](data:image/png;base64...)

*Hình 2.19. Activity Diagram gửi email và hóa đơn PDF*

2.8.9. Sơ đồ tuần tự Use Case Gửi email và hóa đơn

![](data:image/png;base64...)

*Hình 2.20. Sequence Diagram gửi email và hóa đơn PDF*
...
Widget chat nổi trên website với nút mở/đóng, câu chào, quick replies, ô nhập tin nhắn và card sản phẩm do AI trả về.

Lịch sử hội thoại được khôi phục sau khi tải lại trang, phân biệt tin nhắn khách hàng, bot và nhân viên.

Màn hình quản trị phiên chat có bộ lọc chờ xử lý, phiên của tôi, đang xử lý, đã đóng và tất cả; nhân viên có thể nhận phiên, phản hồi, đóng hoặc mở lại.

Màn hình liên hệ/lead báo giá bánh riêng giúp quản trị viên theo dõi yêu cầu do form hoặc AI tạo.

3.2.14. Giao diện email, hóa đơn và xác thực

Đăng ký gửi email xác thực; trang kết quả xác thực thành công, liên kết không hợp lệ hoặc hết hạn.

Quên mật khẩu và trạng thái yêu cầu chờ quản trị viên duyệt.

Hóa đơn PDF được gửi kèm email sau luồng xác nhận/thanh toán phù hợp; công cụ tools/diagnose\_mail.php kiểm tra SMTP, Gmail API hoặc Resend.

Hiện chưa có trang riêng để gửi lại email xác thực; đăng ký lại với cùng username/email đang chờ xác thực sẽ tạo email xác thực mới.
...
|  |  |  |
| --- | --- | --- |
| **API/Tích hợp** | **Endpoint/thành phần** | **Chức năng** |
| PHP chat proxy | /api/chat/send.php, history.php, sessions.php, session\_action.php, agent\_reply.php | Thêm thông tin người dùng/guest token, kiểm tra CSRF quản trị và chuyển tiếp AI service. |
...
Để đánh giá hiệu quả của phân hệ AI chăm sóc khách hàng, đề tài xây dựng quy trình kiểm thử offline theo phương pháp A/B, so sánh hai kiến trúc: Baseline RAG (chỉ truy xuất tri thức rồi sinh câu trả lời) và Multi-Agent RAG (có Router phân loại ý định, Action Agent thực hiện nghiệp vụ và cơ chế Handoff chuyển nhân viên).

4.1. Bộ dữ liệu và phương pháp đánh giá

Bộ dữ liệu gồm 150 mẫu hội thoại tiếng Việt được gán nhãn ý định kỳ vọng và cờ handoff, trong đó 11 mẫu cần chuyển nhân viên và 10 mẫu nhiều lượt. Phân bố ý định: catalog\_search 45, faq 30, product\_recommend 22, order\_status 13, order\_create 10, complaint 8, policy (shipping/payment/return) 15, chitchat 4 và handoff\_request 3.

Mỗi kiến trúc được chạy qua toàn bộ dataset bằng công cụ eval/run\_eval.py; hệ thống ghi lại ý định dự đoán, câu trả lời, tài liệu truy xuất, trích dẫn, cờ handoff và độ trễ từng lượt (tổng 170 lượt mỗi engine, không phát sinh lỗi). Các chỉ số được tính bằng eval/metrics.py. Do sử dụng gói miễn phí của Gemini cho embedding, quá trình chạy có throttle giữa các lượt gọi.
...
| --- | --- | --- |
| **Mã** | **Chỉ số** | **Ý nghĩa** |
| M2 | Grounded rate | Tỷ lệ lượt trả lời có trích dẫn và mọi trích dẫn đều nằm trong tài liệu đã truy xuất. |
| M3 | Intent accuracy | Tỷ lệ phân loại đúng ý định (so ý định lượt cuối với nhãn kỳ vọng). |
| M4 | Handoff P/R/F1 | Chất lượng quyết định chuyển nhân viên (precision, recall, F1). |
| M6 | Task completion | Tỷ lệ mẫu order\_create có phản hồi xác nhận tạo đơn ("Mã đơn #"). |
| — | Latency | Độ trễ phản hồi lượt đầu: trung bình và p95 (ms). |

Ghi chú: M1 (độ chính xác câu trả lời) được chấm tay bởi hai người gán nhãn và đo độ đồng thuận bằng Cohen’s Kappa; M5 (retention) đo trên log vận hành qua truy vấn SQL trên bảng chat\_messages. Hai chỉ số này nằm ngoài phạm vi eval offline.

4.3. Kết quả thực nghiệm

Bảng 4.1. So sánh Baseline RAG và Multi-Agent RAG trên 150 mẫu.

|  |  |  |
| --- | --- | --- |
| **Chỉ số** | **Baseline RAG** | **Multi-Agent RAG** |
| Intent accuracy (M3) | 0,0% | 74,0% |
| Grounded rate toàn bộ (M2) | 92,4% | 46,5% |
| Grounded rate (chỉ ý định truy xuất) | 98% | 70% |
| Handoff precision (M4) | 0,0% | 76,9% |
| Handoff recall (M4) | 0,0% | 90,9% |
| Handoff F1 (M4) | 0,000 | 0,833 |
| Task completion (M6) | 0,0% | 0,0%\* |
| Latency trung bình lượt đầu (ms) | 6173 | 3902 |
| Latency p95 lượt đầu (ms) | 10784 | 9997 |

Bảng 4.2. Độ chính xác phân loại ý định của Multi-Agent RAG theo từng nhóm.

|  |  |  |
| --- | --- | --- |
| **Ý định** | **Đúng/Tổng** | **Tỷ lệ** |
| catalog\_search | 41/45 | 91% |
| order\_status | 12/13 | 92% |
| order\_create | 10/10 | 100% |
| complaint | 7/8 | 88% |
| policy\_shipping | 4/5 | 80% |
| policy\_payment | 4/5 | 80% |
| policy\_return | 5/5 | 100% |
| chitchat | 4/4 | 100% |
| handoff\_request | 3/3 | 100% |
| faq | 13/30 | 43% |
| product\_recommend | 8/22 | 36% |

4.4. Phân tích và nhận xét

Về phân loại ý định, Multi-Agent RAG đạt 74,0% nhờ có Router, trong khi Baseline không phân loại nên bằng 0. Các ý định nghiệp vụ rõ ràng đạt độ chính xác cao (order\_create 100%, order\_status 92%, catalog\_search 91%, complaint 88%). Hai nhóm thấp là faq (43%) và product\_recommend (36%) do dễ bị nhầm sang catalog\_search hoặc policy vì ngữ nghĩa gần nhau; hướng cải thiện là bổ sung ví dụ few-shot và ngưỡng tin cậy cho Router.

Về grounded rate, xét trên toàn bộ lượt, Baseline (92,4%) cao hơn Multi-Agent (46,5%) vì Baseline luôn truy xuất và trích dẫn tài liệu, còn Multi-Agent định tuyến nhiều lượt sang Action/Chitchat (order\_status, order\_create, chitchat) vốn trả lời bằng dữ liệu nghiệp vụ nên không kèm trích dẫn. Khi chỉ xét các ý định truy xuất tri thức, grounded của Multi-Agent là 70% so với 98% của Baseline — cho thấy Baseline an toàn về trích dẫn nhưng thiếu năng lực hành động.

Về handoff, chỉ Multi-Agent có cơ chế chuyển nhân viên, đạt precision 76,9%, recall 90,9% và F1 0,833 — nhận diện tốt các trường hợp khiếu nại hoặc yêu cầu gặp người thật. Về độ trễ, Multi-Agent có độ trễ trung bình lượt đầu thấp hơn (3,9s so với 6,2s) do các ý định action/chitchat bỏ qua bước truy xuất nặng; p95 hai bên tương đương (khoảng 10s), chịu ảnh hưởng của throttle và độ trễ mạng tới LLM.

(\*) Chỉ số Task completion (M6) bằng 0 vì eval offline chạy ở chế độ khách (chưa đăng nhập): với ý định order\_create, AI trả về yêu cầu đăng nhập thay vì tạo đơn, nên không xuất hiện mã đơn. Tuy vậy ý định order\_create vẫn được phân loại đúng 100%; luồng tạo đơn COD thực tế được kiểm thử riêng ở chế độ đã đăng nhập thông qua API nội bộ có chữ ký HMAC.

Tổng kết, kiến trúc Multi-Agent RAG vượt trội về năng lực nghiệp vụ (phân loại ý định, hành động và handoff) cùng độ trễ thấp hơn, đánh đổi bằng grounded rate tổng thể thấp hơn do bản chất đa tác vụ. Baseline RAG phù hợp làm mốc so sánh cho riêng bài toán hỏi–đáp tri thức.
...
* Mailer đa driver linh hoạt giữa môi trường SMTP, Gmail API và Resend; invoice\_email\_sent\_at giúp hạn chế gửi hóa đơn trùng.
* API nội bộ tạo đơn dùng chữ ký HMAC, tách quyền tạo đơn của AI service khỏi truy cập bên ngoài.

5.2.2. Khuyết điểm của hệ thống
...
* Chưa có 2FA, phân quyền nhân viên chi tiết theo vai trò hoặc mã hóa dữ liệu nhạy cảm ở mức ứng dụng.
...
* Hoàn thiện vận hành Resend bằng tài liệu cấu hình, test mock payload, webhook delivered/bounced/complained và giao diện theo dõi trạng thái email.
* Xây dựng giao diện gửi lại email xác thực riêng cho khách chưa nhận email hoặc liên kết đã hết hạn.
* Mở rộng AI để gợi ý combo theo dịp, ngân sách, số người ăn và lịch sử mua hàng; hỗ trợ bán thêm/bán chéo.
* Bổ sung quản lý kho nguyên liệu, định mức theo công thức bánh và cảnh báo sắp hết nguyên liệu.
* Tích hợp MoMo, ZaloPay và phát triển module giao hàng gồm phân công shipper, trạng thái thời gian thực, tối ưu tuyến đường.
* Hoàn thiện phân quyền chủ cửa hàng/nhân viên bán hàng/CSKH/giao hàng, 2FA cho quản trị viên, sao lưu định kỳ và audit log.