...
/** CreateSAMLConnectionRequestBodyAttributeMapping - Define the attribute name mapping between Identity Provider and Clerk's user properties */
class CreateSAMLConnectionRequestBodyAttributeMapping
{
    /**
     *
     * @var ?string $userId
