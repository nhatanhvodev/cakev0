...
class RoleSetItem
{
     ...
     * @phpstan-pure
     */
    public function __construct(RoleSetItemObject $object, string $id, string $name, string $key, int $createdAt, int $updatedAt, ?string $description = null, ?int $membersCount = null, ?bool $hasMembers = null)
    {
        $this->object = $object;
        $this->id = $id;
        $this->name = $name;
