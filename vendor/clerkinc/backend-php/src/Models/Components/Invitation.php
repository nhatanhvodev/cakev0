...
class Invitation
{
     ...
     * @phpstan-pure
     */
    public function __construct(InvitationObject $object, string $id, string $emailAddress, array $publicMetadata, InvitationStatus $status, int $createdAt, int $updatedAt, ?bool $revoked = null, ?string $url = null, ?int $expiresAt = null)
    {
        $this->object = $object;
        $this->id = $id;
