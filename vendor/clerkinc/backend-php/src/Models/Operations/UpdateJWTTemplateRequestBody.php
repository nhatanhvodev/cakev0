...
class UpdateJWTTemplateRequestBody
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $name, UpdateJWTTemplateClaims $claims, ?bool $customSigningKey = null, ?int $lifetime = null, ?int $allowedClockSkew = null, ?string $signingAlgorithm = null, ?string $signingKey = null)
    {
        $this->name = $name;
        $this->claims = $claims;
