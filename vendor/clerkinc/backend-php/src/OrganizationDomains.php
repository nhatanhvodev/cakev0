...
class OrganizationDomains
{
    ...
    public function create(Operations\CreateOrganizationDomainRequestBody $requestBody, string $organizationId, ?Options $options = null): Operations\CreateOrganizationDomainResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateOrganizationDomain', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $organizationId, string $domainId, ?Options $options = null): Operations\DeleteOrganizationDomainResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'DeleteOrganizationDomain', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function listAll(?Operations\ListAllOrganizationDomainsRequest $request = null, ?Options $options = null): Operations\ListAllOrganizationDomainsResponse
    {
        ...
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/organization_domains');
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\ListAllOrganizationDomainsRequest::class, $request, $urlOverride);
        $httpOptions['headers']['Accept'] = 'application/json';
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'ListAllOrganizationDomains', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\ListAllOrganizationDomainsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
        ...
        } elseif (Utils\Utils::matchStatusCodes($statusCode, ['401', '403', '422'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $httpResponse = $this->sdkConfiguration->hooks->afterSuccess(new Hooks\AfterSuccessContext($hookContext), $httpResponse);
    ...
    public function list(Operations\ListOrganizationDomainsRequest $request, ?Options $options = null): Operations\ListOrganizationDomainsResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'ListOrganizationDomains', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
    ...
    public function update(Operations\UpdateOrganizationDomainRequestBody $requestBody, string $organizationId, string $domainId, ?Options $options = null): Operations\UpdateOrganizationDomainResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'UpdateOrganizationDomain', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
