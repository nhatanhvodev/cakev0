...
class RedirectUrls
{
    ...
    public function create(?Operations\CreateRedirectURLRequestBody $request = null, ?Options $options = null): Operations\CreateRedirectURLResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'CreateRedirectURL', null, $this->sdkConfiguration->securitySource);
    ...
    public function delete(string $id, ?Options $options = null): Operations\DeleteRedirectURLResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'DeleteRedirectURL', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function get(string $id, ?Options $options = null): Operations\GetRedirectURLResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'GetRedirectURL', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
    ...
    public function list(?bool $paginated = null, ?int $limit = null, ?int $offset = null, ?Options $options = null): Operations\ListRedirectURLsResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'ListRedirectURLs', null, $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
